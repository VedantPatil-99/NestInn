...
module.exports.renderEditHostelForm = wrapAsync(async (req, res) => {
	let { id } = req.params;
	let hostel = await Hostel.findById(id);
	if (!hostel) {
		req.flash("error", "Hostel not found!");
...
module.exports.updateHostel = wrapAsync(async (req, res) => {
	let { id } = req.params;
	let hostel = await Hostel.findById(id);
...
module.exports.destroyHostel = wrapAsync(async (req, res) => {
	let { id } = req.params;
	let hostel = await Hostel.findById(id);
